...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Must be above the app chrome (BottomNav uses z-50 too); otherwise on mobile the
      // lower part of dialogs can be visually covered / intercept taps.
